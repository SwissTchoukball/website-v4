        ...
        <table class="tableauInsererNews">
            ...
            for($i=0; $i<count($VAR_TABLEAU_DES_LANGUES); $i++){
                ...
                <tr>
                    ...
                    <td width=""><input name="titre<?php echo $VAR_TABLEAU_DES_LANGUES[$i][0];?>" type="text" size="70" maxlength="80"></td>
                </tr>
                <tr>
                    <td valign="top"><p>corps :</p></td>
                    <td><textarea name="corps<?php echo $VAR_TABLEAU_DES_LANGUES[$i][0];?>" cols="67" rows="20"></textarea></td>
                </tr>
                <tr>
                    <td colspan="2">
