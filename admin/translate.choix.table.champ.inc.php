...
if(isset($_POST["action"]) && $_POST["action"]=="afficherTableChamp"){
	...
	$TABLEAU_TRADUCTION = array(
								...
								array("Noms des types d&acute;informations pour classifiés les données","TypeInformation","description","id"),
								...
								array("Noms des origines des contacts (DBD)","DBDOrigineAdresse","descriptionOrigineAdresse","idOrigineAdresse"),
