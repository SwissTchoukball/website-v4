...
if(!isset($_GET['nbMatchs']) OR !isset($_GET['saison']) OR !isset($_GET['idCat']) OR !isset($_GET['idTour']) OR !isset($_GET['idGroupe'])){
	...
	<form id="insererMatchForm" method="post" action="<?php echo "?menuselection=".$menuselection."&smenuselection=".$smenuselection.""; ?>" onSubmit="return validateForm();">
	<?php
					...
					<table class="tableauLieuDateChampionnat">
						...
						<tr>
							...
							<td colspan="3">
								<p>
									<?php echo $agenda_date;?> :
									<select name="debutJour<?php echo $k; ?>" id="debutJour" onChange="selectionAutomatiqueJour<?php echo $k; ?>()">
										<?php echo creation_liste_jour(); ?>
									</select>
									<select name="debutMois<?php echo $k; ?>" id="debutMois" onChange="selectionAutomatiqueMois<?php echo $k; ?>()">
										<?php echo creation_liste_mois(); ?>
									</select>
									<select name="debutAnnee<?php echo $k; ?>" id="debutAnnee" onChange="selectionAutomatiqueAnnee<?php echo $k; ?>()">
										<?php
										$anneeActuelle = date('Y');
										for($i=$saison;$i<=$saison+1;$i++){
											if($i==$anneeActuelle){
									...
									<?php echo $agenda_heure;?> :
									<select name="debutHeure<?php echo $k; ?>" id="debutHeure" onChange="selectionAutomatiqueHeure<?php echo $k; ?>()">
										<?php echo modif_liste_heure("20"); ?>
									</select>
									<select name="debutMinute<?php echo $k; ?>" id="debutMinute" onChange="selectionAutomatiqueMinute<?php echo $k; ?>()">
										<?php echo modif_liste_minute("45"); ?>
									</select>
								</p>
							</td>
