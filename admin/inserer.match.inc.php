...
<?
	...
	if(isset($_POST["action"]) && $_POST["action"]=="insererMatch"){
		...
		$forfait = 0;
		if($recevantGagneParForfait) $forfait = 1;
		if($visiteurGagneParForfait) $forfait = 2;		
		...
		if(mysql_num_rows($recordset) != 1) $nbErreur++;
		...
		if($nbErreur==0){
			...
			if(dateDebutFinValide($debutAnnee,$debutMois,$debutJour,$debutHeure,$debutMinute,
				...
				if($matchReporte && !dateDebutFinValide($debutAnneeReporteAu,$debutMoisReporteAu,$debutJourReporteAu,$debutHeureReporteAu,$debutMinuteReporteAu,
...
<table width="80%" border="0" align="center">
  <tr>
    <td height="44"><table border="0" align="center">
      <tr>
        <td><h3>Match</h3></td>
      </tr>
    </table>    <p>&nbsp;</p>
    <table border="0" align="center">
      ...
      <tr>
        <td align="right"><p>Gagne par forfait<input name="recevantGagneParForfait" type="checkbox" class='couleurCheckBox'  onclick="changeEtatForfait(this);" DISABLED></p>
        <td></td>
        <td><p><input name="visiteurGagneParForfait"  type="checkbox" class='couleurCheckBox' onclick="changeEtatForfait(this);" DISABLED>Gagne par forfait</p></td>
      </tr>			
    </table>
      <p>&nbsp;</p>
      <table border="0" align="center">
        <tr>
          ...
          <td width="150"><p>Groupe :
                  <select name="groupe">
                    <? $requeteSQL = "SELECT * FROM ChampionnatGroupe ORDER BY numeroGroupe";
						 $recordset = mysql_query($requeteSQL);
	    ...
	    <p>&nbsp;</p>
			...
			<table width="400" border="0" align="center">
				...
				<table width="400" border="0" align="center">
					<tr>
						<td>
							<p>Match report&eacute; <input name="matchReporte" type="checkbox" onClick="changePartieAgendaReporte(this);" class='couleurCheckBox'></p>
						</td>				
					</tr>
						...
						<td><h4>Match reporté au</h4>
							<table width="400" border="0" align="center">
								...
								<tr> 
									<td><p><? echo $agenda_debut;?></p></td>
									<td><p><? echo $agenda_date;?> : 
										<select name="debutJourReporteAu" id="debutJourReporteAu" onChange="selectionAutomatiqueJourReporteAu()">
											<? echo creation_liste_jour(); ?> </select> <select name="debutMoisReporteAu" id="debutMoisReporteAu" onChange="selectionAutomatiqueMoisReporteAu()">
											<? echo creation_liste_mois(); ?> </select> <select name="debutAnneeReporteAu" id="debutAnneeReporteAu" onChange="selectionAutomatiqueAnneReporteAu()">
											<? echo creation_liste_annee(0,5); ?> 
										</select>
										<? echo $agenda_heure;?> : 
										<select name="debutHeureReporteAu" id="debutHeureReporteAu" onChange="selectionAutomatiqueHeureReporteAu()">
											<? echo creation_liste_heure(); ?> </select> <select name="debutMinuteReporteAu" id="debutMinuteReporteAu">
											<? echo creation_liste_minute(); ?> </select></p></td>
								</tr>
								<tr> 
									<td><p><? echo $agenda_fin;?></p></td>
									<td><p><? echo $agenda_date;?> : 
										<select name="finJourReporteAu" id="finJourReporteAu">
											<? echo creation_liste_jour(); ?> </select> <select name="finMoisReporteAu" id="finMoisReporteAu">
											<? echo creation_liste_mois(); ?> </select> <select name="finAnneeReporteAu" id="finAnneeReporteAu">
											<? echo creation_liste_annee(0,5); ?> 
										</select>
										<? echo $agenda_heure;?> : 
										<select name="finHeureReporteAu" id="finHeureReporteAu">
											<? echo creation_liste_heure(); ?> </select> <select name="finMinuteReporteAu" id="finMinuteReporteAu">
											<? echo creation_liste_minute(); ?> </select></p></td>
								</tr>					
							</table>
						</td>
