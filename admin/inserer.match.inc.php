								...
								<tr>
									...
									<td><p><?php echo $agenda_date;?> :
										<select name="debutJourReporteAu" id="debutJourReporteAu" onChange="selectionAutomatiqueJourReporteAu()">
											<?php echo creation_liste_jour(); ?> </select> <select name="debutMoisReporteAu" id="debutMoisReporteAu" onChange="selectionAutomatiqueMoisReporteAu()">
											<?php echo creation_liste_mois(); ?> </select> <select name="debutAnneeReporteAu" id="debutAnneeReporteAu" onChange="selectionAutomatiqueAnneReporteAu()">
											<?php echo creation_liste_annee(0,5); ?>
										</select>
										<?php echo $agenda_heure;?> :
										<select name="debutHeureReporteAu" id="debutHeureReporteAu" onChange="selectionAutomatiqueHeureReporteAu()">
											<?php echo creation_liste_heure(); ?> </select> <select name="debutMinuteReporteAu" id="debutMinuteReporteAu">
											<?php echo creation_liste_minute(); ?> </select></p></td>
								</tr>
								<tr>
									<td><p><?php echo $agenda_fin;?></p></td>
									<td><p><?php echo $agenda_date;?> :
										<select name="finJourReporteAu" id="finJourReporteAu">
											<?php echo creation_liste_jour(); ?> </select> <select name="finMoisReporteAu" id="finMoisReporteAu">
											<?php echo creation_liste_mois(); ?> </select> <select name="finAnneeReporteAu" id="finAnneeReporteAu">
											<?php echo creation_liste_annee(0,5); ?>
										</select>
										<?php echo $agenda_heure;?> :
										<select name="finHeureReporteAu" id="finHeureReporteAu">
											<?php echo creation_liste_heure(); ?> </select> <select name="finMinuteReporteAu" id="finMinuteReporteAu">
											<?php echo creation_liste_minute(); ?> </select></p></td>
								</tr>
							</table>
						</td>
