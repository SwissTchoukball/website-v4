...
<form name="insertion" method="post" action="<?php echo"?menuselection=$menuselection&smenuselection=$smenuselection"; ?>" onSubmit="return chronologieDate();">
  <table width="400" border="0" align="center">
    <tr>
      ...
      <td><input name="description" type="text" id="description3" size="70" maxlength="70" value="<?php echo $record["description"];?>"></td>
    </tr>
    <tr>
      <td><p><?php echo $agenda_lieu;?></p></td>
      <td><input name="lieu" type="text" id="lieu4" size="50" maxlength="50" value="<?php echo $record["lieu"];?>"></td>
    </tr>
    <tr>
      ...
      <td><p><?php echo $agenda_date;?> :
        <select name="debutJour" id="debutJour" onChange="selectionAutomatiqueJour()">
          <?php echo modif_liste_jour(jour($record["dateDebut"])); ?> </select> <select name="debutMois" id="debutMois" onChange="selectionAutomatiqueMois()">
          <?php echo modif_liste_mois(mois($record["dateDebut"])); ?> </select> <select name="debutAnnee" id="debutAnnee" onChange="selectionAutomatiqueAnne()">
        ...
        <select name="debutHeure" id="debutHeure" onChange="selectionAutomatiqueHeure()">
          <?php echo modif_liste_heure(heure($record["heureDebut"])); ?> </select> <select name="debutMinute" id="debutMinute">
    ...
    <tr>
      ...
      <td><p><?php echo $agenda_date;?> :
        <select name="finJour" id="finJour">
          <?php echo modif_liste_jour(jour($record["dateFin"])); ?> </select> <select name="finMois" id="finMois">
          <?php echo modif_liste_mois(mois($record["dateFin"])); ?> </select> <select name="finAnnee" id="finAnnee">
          <?php echo modif_liste_annee(0,5,annee($record["dateFin"])); ?>
        </select>
        <?php echo $agenda_heure;?> :
        <select name="finHeure" id="finHeure">
          <?php echo modif_liste_heure(heure($record["heureFin"])); ?> </select> <select name="finMinute" id="finMinute">
