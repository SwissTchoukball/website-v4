...
<form name="modifierTour" method="post" action="<?php echo"?menuselection=$menuselection&smenuselection=$smenuselection"; ?>">
		...
		<input type="hidden" name="tourPrecedent" value="<? echo $tourPrecedent; ?>">
		<input type="hidden" name="idGroupe" value="<? echo $_POST['idGroupe']; ?>">
		<input type="hidden" name="action" value="modifierTour">
				
    <p align="center">
          <input type="submit" name="modifier_tour" value="<? echo VAR_LANG_MODIFIER; ?>" onclick="return validateForm();">
		</p>
</form>
