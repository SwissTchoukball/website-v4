<div id="clubs">
	...
	<p><a href="?menuselection=<? echo $menuselection; ?>&smenuselection=<? echo $smenuselection; ?>&new"><img src="admin/images/ajouter.png" alt="Ajouter un club" /> Ajouter un club</a><br />
	<a href="?menuselection=<? echo $menuselection; ?>&smenuselection=<? echo $smenuselection; ?>"><img src="admin/images/liste.png" alt="Liste des clubs" /> Liste des clubs</a></p>
