...
<form name="form1" method="post" action="<?php echo"?menuselection=$menuselection&smenuselection=$smenuselection"; ?>">
    <table class="tableauInsererNews">
        ...
        <tr>
            ...
            <td><textarea name="corps<?php echo $VAR_TABLEAU_DES_LANGUES[$i][0];?>" cols="67" rows="20"><?php echo $record["corps".$VAR_TABLEAU_DES_LANGUES[$i][0]]?></textarea></td>
        </tr>
        <tr>
            <td colspan="2">
    ...
    <div class="listeImagesNews">
            Image :<br />
            <input type='radio' name='image' value='false' id='aucun' <?php if($record["image"]==0){ echo "checked='checked'"; } ?> /> <label for='aucune'>Aucune</label><br />
        <?php
        ...
        <div class="optionsNews">
            <p><input type="checkbox" name="premiereNews" class="couleurCheckBox" <?php echo $record["premiereNews"]==0?"":"checked";?>>
