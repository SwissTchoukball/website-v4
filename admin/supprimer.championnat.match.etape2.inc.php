...
if(!(isset($_POST['saison']) AND isset($_POST['categorie']) AND isset($_POST['tour']) AND isset($_POST['idGroupe']))){
    ...
    ?>
    <form name="supprimerMatch" method="post" action="<?php echo"?menuselection=$menuselection&smenuselection=$smenuselection"; ?>" onSubmit="return testQqchASupprimer();"><table class="tableauSupprimerMatch">
        <?
        echo "<tr>";
           echo "<th>X</th>";
           echo "<th>Date</th>";
        ...
        <input type="submit" name="submit" value="<? echo VAR_LANG_SUPPRIMER;?>">
    </form>
    <?
}