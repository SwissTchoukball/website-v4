<div class="agendaOutlook">
    ...
    {
        $dateRappel = date("d-m-Y",
            mktime(0, 0, 0, mois($record["dateDebut"]), jour($record["dateDebut"]) - 1, annee($record["dateDebut"])));
    ...
    <p align="justify">Gr&acirc;ce à ce fichier, vous aurez toutes les dates de l'agenda
        ...
        outlook <a href='<?php echo $cheminFichierAgenda; ?>'>ici (<?php echo tailleFichier($cheminFichierAgenda); ?>
            ).</a>
    ...
    <table width="100%" border="0">
        ...
        <tr>
            <td>
                <div align="center"><img src="/pictures/installation_aganda_outlook/phase_1.gif" width="270"
                                         height="266"></div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <div align="center"><img src="/pictures/installation_aganda_outlook/phase_2.gif" width="597"
                                         height="334"></div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <div align="center"><img src="/pictures/installation_aganda_outlook/phase_3.gif" width="597"
                                         height="334"></div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <div align="center"><img src="/pictures/installation_aganda_outlook/phase_4.gif" width="597"
                                         height="334"></div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <div align="center"><img src="/pictures/installation_aganda_outlook/phase_5.gif" width="597"
                                         height="334"></div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <div align="center"><img src="/pictures/installation_aganda_outlook/phase_6.gif" width="597"
                                         height="334"></div>
            </td>
        </tr>
    </table>
