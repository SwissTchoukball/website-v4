...
<!-- combbox -->
<form name="translateType" action="" method="post"><table border="0" align="center">
  <tr>
	<td><p><? echo "Page à traduire"; ?> :</p></td>
	<td><select name="translatePage" id="select" onChange="if(validForm())translateType.submit();">
	 <? 	 
					...
					while ($record = mysql_fetch_array($recordset)){						
						...
						// first as default
						if(!isset($translatePage))$translatePage=$translateId;
...
<table>
<form name="translateText" action="<?php echo"?menuselection=$menuselection&smenuselection=$smenuselection"; ?>" method="post" onsubmit="if(!isDataModified()){alert('rien à modifier'); return false;}"><table border="0" align="center">
...
<br/>
<input type="hidden" name="nbSection" value="<? echo $sectionNum; ?>"/>
<input type="hidden" name="action" value="modifierText"/>
<p align="center"><input type="submit" value="<? echo VAR_LANG_MODIFIER;?>"/> </p>
</form>
<!-- <input type="submit" value="<? echo VAR_LANG_ANNULER;?>"/> -->
<div align="center"><form name="annuler"  onsubmit="return validForm();" method="post" action="<?php echo"?menuselection=$menuselection&smenuselection=$smenuselection"; ?>"><input type="submit" value="<? echo VAR_LANG_ANNULER?>"></form></div>	
