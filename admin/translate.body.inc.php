...
<div align="center"><form name="annuler"  onsubmit="return validForm();" method="post" action="<?php echo"?menuselection=$menuselection&smenuselection=$smenuselection"; ?>"><input type="submit" value="<?php echo VAR_LANG_ANNULER?>"></form></div>
