<table class="tableauStatistiquePersonne">
    ...
    function afficherStatistique($ratio)
    {
        ...
        if ($longueurRecouvrement != 0) {
            echo "<img src='" . VAR_LOOK_path . "partie_stat_centrale_recouvrement.gif' width='" . $longueurRecouvrement . "px' height='" . $sizeImage[1] . "px'></td>";
        } else {
            echo "</td>";
        }
        if ($longueurRecouvrement == 0) {
            echo "<td class='noborder' width='1px'><img src='" . VAR_LOOK_path . "partie_stat_droite_full.gif'></td>";
        } else {
            echo "<td class='noborder' width='1px'><img src='" . VAR_LOOK_path . "partie_stat_droite.gif'></td>";
        }
        echo "</tr></table>";
    }
