				...
				while($donneesVerification=mysql_fetch_array($retourVerification)){
					if($donneesVerification['Canton']=="event"){
						...
						if($donneesVerification['dateDebut']==$donneesVerification['dateFin']){
							echo " ".date_sql2date_joli($donneesVerification['dateDebut'],$agenda_le,$_SESSION['__langue__']);
						}
						else{
							echo " ".date_sql2date_joli($donneesVerification['dateDebut'],$agenda_du,$_SESSION['__langue__'])." ".date_sql2date_joli($donneesVerification['dateFin'],$agenda_au,$_SESSION['__langue__']).".";
						}
						echo "</p>";
					}
					else{
