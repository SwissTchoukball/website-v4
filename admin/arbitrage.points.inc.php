...
if (hasRefereeManagementAccess()) {
	...
	<div><a href="?menuselection=<?php echo $_GET['menuselection']; ?>&smenuselection=<?php echo $_GET['smenuselection']; ?>&gerer"><img src="admin/images/modifier.png" alt="Gérer les points distribués" /> Gérer les points distribués</a></div>
	<div><a href="?menuselection=<?php echo $_GET['menuselection']; ?>&smenuselection=<?php echo $_GET['smenuselection']; ?>"><img src="admin/images/liste.png" alt="Liste des points distribués" /> Liste des points distribués</a></div>
	<br />
	<?php
}
