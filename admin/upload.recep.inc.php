         ...
         if ($_FILES['aFile']['size'] <= $file_max_size) {
           ...
           if ($lastPos !== false && in_array(strToLower(subStr($lastPos, 1)), $authorized_extensions)) {
            ...
            if (move_uploaded_file($_FILES['aFile']['tmp_name'],
                ...
                $uploadReussi = true;
                ?>
                Votre fichier se trouve &agrave; l'adresse suivante: <a href="http://www.tchoukball.ch/uploads/<?php echo $destination_file; ?>" target="_blank">http://www.tchoukball.ch/uploads/<?php echo $destination_file; ?></a><br />
                <?php
