...
if ($_POST['postType'] == "newMember" || $_POST['postType'] == "editMember") {
    ...
    } else if (hasAllMembersManagementAccess() || ($_SESSION['__nbIdClub__'] == $clubID && $_SESSION['__gestionMembresClub__'])) { // Pas d'erreur. On vérifie bien que c'est une personne autorisée qui procède à l'ajout ou la modification
        $newMember = false;
