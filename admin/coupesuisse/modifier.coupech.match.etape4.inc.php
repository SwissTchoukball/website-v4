...
?>
<p class="center"><a href="?menuselection=<?php echo $menuselection; ?>&smenuselection=<?php echo $smenuselection; ?>">Modifier d'autres matchs</a></p><br />
<p class="center"><a href="?menuselection=<?php echo $menuselection; ?>&smenuselection=<?php echo $smenuselection; ?>&modAnnee=<?php echo $_POST['annee']; ?>&modCat=<?php echo $_POST['idCategorie']; ?>">Modifier d'autres matchs de la même édition</a></p>
