...
?>
<p class="center"><a href="?menuselection=<? echo $menuselection; ?>&smenuselection=<? echo $smenuselection; ?>">Modifier d'autres matchs</a></p><br />
<p class="center"><a href="?menuselection=<? echo $menuselection; ?>&smenuselection=<? echo $smenuselection; ?>&modAnnee=<? echo $_POST['annee']; ?>&modCat=<? echo $_POST['idCategorie']; ?>">Modifier d'autres matchs de la même édition</a></p>
