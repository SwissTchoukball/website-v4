...
<form method="post" action="" id="formulaireInsertionCoupeCH" onSubmit="return checkSaisie();">
    ...
    <fieldset>
        ...
        for($k=1;$k<=$_POST['nbEquipes'];$k++){
            ...
            <select name="equipe<?php echo $k; ?>" id="equipe<?php echo $k; ?>" onChange="testAutoQualif();testDoublons(this);">
                ...
                while($donneesEquipes=mysql_fetch_array($retourEquipes)){
                    ?>
                    <option value="<?php echo $donneesEquipes['idEquipe']; ?>"><?php echo $donneesEquipes['nomEquipe']?></option>
                    <?php
                }
                ?>
            </select>
