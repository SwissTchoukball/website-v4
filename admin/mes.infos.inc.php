<div><?php
    ...
    $requeteSQL = "SELECT *, p.email, c.club FROM `Personne` p,`ClubsFstb` c WHERE p.`nom`='" . addslashes($_SESSION["__nom__"]) . "' AND p.`prenom`='" . addslashes($_SESSION["__prenom__"]) . "' AND p.`idClub`=c.`id`";
