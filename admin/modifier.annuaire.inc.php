...
<p>Dernière modification le <?php echo date_sql2date($record["derniereModification"]);?> &agrave; <?php echo substr($record["derniereModification"],11);?> par <?php echo $record["modificationPar"];?></p>
...
<div align="center"><form name="annuler" method="post" action="<?php echo"?menuselection=$menuselection&smenuselection=$smenuselection"; ?>"><input type="submit" value="<?php echo VAR_LANG_ANNULER?>"></form></div>
