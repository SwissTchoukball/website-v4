...
$VAR_G_MOIS = array("January","February","March","April","May","June","July","August","September","October","November","December");
...
function sufixDate($dateJourMoisNum){
	if($dateJourMoisNum==1)return "st";
	else if($dateJourMoisNum==2)return "nd";
	else if($dateJourMoisNum==3)return "rd";
	else return "th";
}
...
define("VAR_LANG_PAS_TOUCHER_POUR_RESOUDRE_EGALITE",  "Don't touch if the ties are going to be solved with the coming matches.");
...
define("VAR_LANG_OPTION_VEROUILLEE","option vérouillée");
