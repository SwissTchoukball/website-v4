...
if (isset($_GET['idEvenement'])) {
    ...
    $timestampPremierJourMoisSuivant = mktime(0, 0, 0, $mois + 1, 1,
        $annee); // timestamp du 1er $mois+1 $annee à minuit.
    ...
    $timestampDernierJourMois = mktime(0, 0, 0, $mois, $nombreJoursMois,
        $annee); // timestamp du dernier jour $mois $annee à minuit.
    ...
    <ul id="abonnementsCalendrier" style="display: none;">
        <li><a href="webcal://<?php echo $_SERVER['HTTP_HOST']; ?>/fstb-calendar.php">Tous les autres événements sauf le
                championnat</a></li>
        <li><a href="webcal://<?php echo $_SERVER['HTTP_HOST']; ?>/fstb-calendar.php?championnat">Matchs de
                championnat</a></li>
        <li><a href="webcal://<?php echo $_SERVER['HTTP_HOST']; ?>/fstb-calendar.php?entrainements">Entraînements</a>
        </li>
        <?php
