...
<table class="formagenda">
	...
	<tr>
		<td align="right"><p><? echo $agenda_categories;?> :</p></td>
	...
	<tr> 
			<td align="center" colspan="2"> 
					<input type="submit" name="Submit" value="<? echo $agenda_actualiser; ?>">
			</td>
	</tr>	
</table>
</form>
...
<table class="agenda" >
    <tr>
        <th width="60px"><? echo $agenda_du; ?></th>				
        <th width="60px"><? echo $agenda_au; ?></th>							
        <th><? echo $agenda_type; ?></th>				
	...
	while($record = mysql_fetch_array($recordset)){
		...
		<tr bgcolor="#<? echo $couleur; ?>">
			...
			<td align="center"><? echo $dateFin; ?></td>							
			<td><? echo $nomType; ?></td>
    ...
    ?>
    <tr>
        <th><? echo $agenda_du;?></th>			
        <th><? echo $agenda_au;?></th>						
        <th><? echo $agenda_type;?></th>				
        <th><? echo $agenda_description;?></th>				
        <th><? echo $agenda_lieu;?></th>								
