<div class="resultatsCoupeCH">
    ...
    <div class="informationsMatch" style="display:none;" id="infomatch1">
        ...
        <div class="informationsBoxDate">20.01.2008 à 9h00</div>
    </div>
    -->
    <div class="informationsMatch" style="display:none;" id="infomatch1">
        <div class="informationsBoxJournee">Journée 1</div>
        <div class="informationsBoxTypeMatch">Huitième de finale</div>
        <div class="informationsBoxEquipes">Lausanne 2 - Genève 1</div>
        <div class="informationsBoxScore">Score final : 2 - 3</div>
        <div class="informationsBoxLieu">Riveraine, Neuchâtel</div>
        <div class="informationsBoxDate">20.01.2008 à 11h30</div>
    </div>
    <div class="informationsMatch" style="display:none;" id="infomatch2">
        <div class="informationsBoxJournee">Journée 1</div>
        <div class="informationsBoxTypeMatch">Huitième de finale</div>
        <div class="informationsBoxEquipes">Genève 3 - Lausanne 1</div>
        <div class="informationsBoxSet">Genève 3 discalifié pour joueur non-préinscrit</div>
        <div class="informationsBoxLieu">Riveraine, Neuchâtel</div>
        <div class="informationsBoxDate">20.01.2008 à 9h30</div>
    </div>
    <div class="informationsMatch" style="display:none;" id="infomatch3">
        <div class="informationsBoxJournee">Journée 1</div>
        <div class="informationsBoxTypeMatch">Huitième de finale</div>
        <div class="informationsBoxEquipes">Nyon - Val-de-Ruz 1</div>
        <div class="informationsBoxSet">Nyon a déclaré forfait.</div>
        <div class="informationsBoxLieu">Riveraine, Neuchâtel</div>
        <div class="informationsBoxDate">20.01.2008 à 9h30</div>
    </div>
    ...
    <div class="informationsMatch" style="display:none;" id="infomatch5">
        <div class="informationsBoxJournee">Journée 1</div>
        <div class="informationsBoxTypeMatch">Huitième de finale</div>
        <div class="informationsBoxEquipes">Chaux-de-Fonds - Chavannes 1</div>
    ...
    <div class="informationsMatch" style="display:none;" id="infomatch6">
        <div class="informationsBoxJournee">Journée 1</div>
        <div class="informationsBoxTypeMatch">Huitième de finale</div>
        <div class="informationsBoxEquipes">Genève 2 - UniNE</div>
    ...
    <div class="informationsMatch" style="display:none;" id="infomatch7">
        <div class="informationsBoxJournee">Journée 1</div>
        <div class="informationsBoxTypeMatch">Huitième de finale</div>
        <div class="informationsBoxEquipes">Chavannes 2 - Neuchâtel</div>
    ...
    <div class="informationsMatch" style="display:none;" id="infomatch9">
        <div class="informationsBoxJournee">Journée 1</div>
        <div class="informationsBoxTypeMatch">Quart de finale</div>
        <div class="informationsBoxEquipes">Genève 1 - Lausanne 1</div>
        <div class="informationsBoxScore">Score final : 0 - 3</div>
        <div class="informationsBoxLieu">Riveraine, Neuchâtel</div>
        <div class="informationsBoxDate">20.01.2008 à 15h30</div>
    </div>
    <div class="informationsMatch" style="display:none;" id="infomatch10">
        <div class="informationsBoxJournee">Journée 1</div>
        <div class="informationsBoxTypeMatch">Quart de finale</div>
        <div class="informationsBoxEquipes">Val-de-Ruz 1 - Chambésy</div>
        <div class="informationsBoxScore">Score final : 2 - 3</div>
        <div class="informationsBoxLieu">Riveraine, Neuchâtel</div>
        <div class="informationsBoxDate">20.01.2008 à 13h30</div>
    </div>
    <div class="informationsMatch" style="display:none;" id="infomatch11">
        <div class="informationsBoxJournee">Journée 1</div>
        <div class="informationsBoxTypeMatch">Quart de finale</div>
        <div class="informationsBoxEquipes">Chaux-de-Fonds - Genève 2</div>
        <div class="informationsBoxScore">Score final : 3 - 1</div>
        <div class="informationsBoxLieu">Riveraine, Neuchâtel</div>
        <div class="informationsBoxDate">20.01.2008 à 15h30</div>
    </div>
    <div class="informationsMatch" style="display:none;" id="infomatch12">
        <div class="informationsBoxJournee">Journée 1</div>
        <div class="informationsBoxTypeMatch">Quart de finale</div>
        <div class="informationsBoxEquipes">Neuchâtel - Val-de-Ruz 2</div>
        <div class="informationsBoxScore">Score final : 3 - 1</div>
        <div class="informationsBoxLieu">Riveraine, Neuchâtel</div>
        <div class="informationsBoxDate">20.01.2008 à 13h30</div>
    </div>
    <div class="informationsMatch" style="display:none;" id="infomatch13">
        ...
        <div class="informationsBoxTypeMatch">Demi-finale</div>
        <div class="informationsBoxEquipes">Lausanne 1 - Chambésy</div>
        <div class="informationsBoxScore">Score final : 3 - 1</div>
        <div class="informationsBoxLieu">Plaine, Chavannes-près-Renens</div>
        <div class="informationsBoxDate">01.03.2008 à 11h30</div>
    </div>
    <div class="informationsMatch" style="display:none;" id="infomatch14">
        <div class="informationsBoxJournee">Journée 2</div>
        <div class="informationsBoxTypeMatch">Demi-finale</div>
        <div class="informationsBoxEquipes">Chaux-de-Fonds - Neuchâtel</div>
        <div class="informationsBoxScore">Score final : 3 - 2</div>
        <div class="informationsBoxLieu">Plaine, Chavannes-près-Renens</div>
        <div class="informationsBoxDate">01.03.2008 à 9h00</div>
    </div>
    <div class="informationsMatch" style="display:none;" id="infomatch15">
        <div class="informationsBoxJournee">Journée 2</div>
        <div class="informationsBoxTypeMatch">Finale</div>
        <div class="informationsBoxEquipes">Lausanne 1 - Chaux-de-Fonds</div>
        <div class="informationsBoxScore">Score final : 3 - 0</div>
        <div class="informationsBoxLieu">Plaine, Chavannes-près-Renens</div>
        <div class="informationsBoxDate">01.03.2008 à 17h00</div>
    </div>
    <div class="informationsMatch" style="display:none;" id="infomatch16">
        <div class="informationsBoxJournee">Journée 2</div>
        <div class="informationsBoxTypeMatch">Petite finale</div>
        <div class="informationsBoxEquipes">Chambésy - Neuchâtel</div>
        <div class="informationsBoxScore">Score final : 3 - 0</div>
        <div class="informationsBoxLieu">Plaine, Chavannes-près-Renens</div>
        <div class="informationsBoxDate">01.03.2008 à 14h45</div>
    </div>
    <div class="boxTour1">
        <div class="boxEquipe1A" onMouseOver="afficherInfoMatch('1');" onMouseOut="masquerInfoMatch('1');">
            <span class="perdant">Lausanne 2</span>
        </div>
    ...
    <div class="boxTour3">
        ...
        <div class="boxEquipe3B" onMouseOver="afficherInfoMatch('13');" onMouseOut="masquerInfoMatch('13');">
            <span class="perdant">Chambésy</span>
        </div>
        ...
        <div class="boxEquipe3B" onMouseOver="afficherInfoMatch('14');" onMouseOut="masquerInfoMatch('14');">
            <span class="perdant">Neuchâtel</span>
        </div>
    </div>
    <div class="boxTour4">
