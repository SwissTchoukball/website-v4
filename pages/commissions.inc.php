...
$requeteSQLCommission = "SELECT cn.id, cn.nomCom" . $_SESSION["__langue__"] . " AS nomCommission, cn.lien, p.idDbdPersonne, p.nom, p.prenom, p.adresse, p.cp, p.npa, p.ville, p.emailFSTB, p.email, p.telPrive, p.portable
