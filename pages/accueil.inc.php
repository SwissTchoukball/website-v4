    ...
    while ($donnees = mysql_fetch_array($requete)) {
        ...
        <div class="socialButtons">
            <a href="http://twitter.com/share" class="twitter-share-button"
               data-url="http://www.tchoukball.ch/news/<?php echo $donnees['id']; ?>"
               data-text="FSTB : <?php echo strip_tags($titre); ?>" data-count="none" data-via="tchouksuisse"
               data-lang="<?php echo strtolower($_SESSION['__langue__']); ?>">Tweet</a>
            <!-- Javascript dans le footer -->
            <fb:like href="http://www.tchoukball.ch/news/<?php echo $donnees['id']; ?>" send="true"
                     layout="button_count" width="450" show_faces="false" font="lucida grande"></fb:like>
        </div>
        <?php
    }
    /*echo "<p class='center'>";
        ...
        while ($donneesNbClassementC = mysql_fetch_array($retourNbClassementC)) {
            ...
            if ($idTour != 10000) { // Pas un tour final
                ...
                for ($k = 1; $k < count($tableau); $k++) {
                    ...
                    echo "<td>" . afficherRang($idTour, $typeClassement, $donneesEquipeClassement['nbMatchGagne'],
