...
//R�cup�ration de la liste des arbitres
...
?>
    ...
    <form onsubmit="$event.preventDefault()">
        ...
        <table class="formagenda">
            <tr>
                ...
                <td align="left">
                    <select name="annee" id="seasonSelector" title="Ann�e" onChange="updateSelection();">
                        <?php
    ...
    if (!$retour) {
        printErrorMessage("Erreur lors de la r�cup�ration de la liste des matchs.<br />Message : " . mysql_error() . "<br />Requ�te : " . $requete);
    } else {
        $nbMatchs = mysql_num_rows($retour);
        if ($nbMatchs == 0) {
            printBlankSlateMessage("Aucun match planifi� pour la s�lection.");
        } else {
        ?>
                        ...
                        <td>
                            ...
                            <div class="arbitres" style="display: none;">
                                ...
                                if ($refereesString != '') {
                                    ...
                                    echo 'Aucun arbitre indiqu� pour le moment.';
                                }
                                ?>
                            </div>
                        </td>
