<?	
	...
	$entete_download = array($agenda_heure,$agenda_categories,VAR_LANG_EQUIPE,"-",VAR_LANG_EQUIPE,VAR_LANG_MATCH,VAR_LANG_RESULTAT);	
	...
	while($record = mysql_fetch_array($recordset)){
		...
		$lastColor=$record["couleur"];
			...
			if($record["idParticipantA"]==1) echo "<font color='#FF0000'><strong>".$record["nomPartA"]."</strong></font>";
			else echo $record["nomPartA"];			
			echo "</p></td>";
			echo "<td><p>-</p></td>";
			echo "<td><p>";
			if($record["idParticipantB"]==1) echo "<font color='#FF0000'><strong>".$record["nomPartB"]."</strong></font>";
			else echo $record["nomPartB"];			
			echo "</p></td>";
			if($record["idFinale"]>0 && $record["idFinale"]!=8) echo "<td><p><strong>".$record["nomFinale"]."</strong></p></td>";
			else echo "<td><p>".$record["nomFinale"]."</p></td>";
