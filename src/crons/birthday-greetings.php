...
<body>
	...
	<p>Profitez bien de votre journée, vos amis et votre famille. Nous vous souhaitons une année pleine de réussite.</p>
	<p>Nous saisissons cette occasion pour vous remercier pour tout ce que vous faites ou avez fait pour de notre sport en Suisse. Vous pouvez être %s d'avoir apporté votre pierre au grand édifice qu'est le développement du tchoukball en notre pays.</p>
...
$query = "SELECT nom, prenom, dateNaissance, idSexe, TIMESTAMPDIFF(YEAR, dateNaissance, CURDATE()) AS age, email, emailFSTB
		  FROM Benevoles
