...
$VAR_G_MOIS = array("Januar","Februar","M&auml;rz","April","Mai","Juni","Juli","August","September","Oktober","November","Dezembre");
...
// Telechargement
define("VAR_LANG_DOC_NOM_LIEN_FLYER_PRESENTATION","Das Vorstellungsprospekt downloaden"); // nom lien flyer presentation
define("VAR_LANG_DOC_FLYER_PRESENTATION","document/De_flyer_presentation.pdf"); // flyer presentation

// championnat
$aujourd_hui = getdate();
$anneeStart = $aujourd_hui["year"];
define("VAR_LANG_CHAMPIONNAT_NON_COMMENCE","Die ".$anneeStart."-".($anneeStart+1)." Meisterschaft hat noch nicht begonnen.");
...
define("VAR_LANG_LIST_MODIFIER","Die Veränderung einer Eingabe führt zur Veränderung des Wertes aller Ressourcen, die diesen Wert gebrauchen. ");
define("VAR_LANG_LIST_INSERER","Das Einfügen einer neuen Eingabe führt zu einer neuen Möglichkeit dort, wo die Liste gebraucht wird.");
define("VAR_LANG_LIST_SUPPRIMER","Das Löschen einer Option (Eingabe) kann schwere Auswirkungen auf die Kohärenz der Daten haben; allein der Webmaster kann Eingaben in den Listen löschen. Nehmen Sie bitte mit ihm Kontakt auf, falls Sie eine Eingabe löschen möchten. ");
