<?
	...
	function dateDebutFinValide($debutAnnee, $debutMois, $debutJour, $debutHeure, $debutMinute,
	...
	//Remarques:                                                                 //
	///////////////////////////////////////////////////////////////////////////////
	function jour($date){return substr($date,8,2);}
	function mois($date){return substr($date,5,2);}
	...
	//Remarques:                                                                 //
	///////////////////////////////////////////////////////////////////////////////
	function heure($heure){return substr($heure,0,2);}
	function minute($minute){return substr($minute,3,2);}
	function seconde($seconde){return substr($seconde,6,2);}
	...
	function date_egales($date1, $date2){
	   ...
	   if ($jour1 == $jour2 && $mois1 == $mois2 && $annee1 == $annee2) {return 1;}
	   else {return 0;}
	}
	...
	function date1_inf_date2($date1, $date2){
	   ...
	   if ($annee1 == $annee2 && $mois1 < $mois2){return 1;}
	   if ($annee1 == $annee2 && $mois1 == $mois2 && $jour1 < $jour2){return 1;}
	   else {return 0;}
	}
	...
	function creation_liste_jour(){
	   ...
	   for ($i = 1; $i <= 31; $i++){
		  ...
		  if ($i >= 10){$option .= "<option value='$i'>$i</option>\n";}
	   }
	   return $option;
	}
	...
	function modif_liste_jour($jour){
	   ...
	   for ($i = 1; $i <= 31; $i++){
			if ($i < 10){
			 if ($i == $jour){$option .= "<option value='0$i' selected>0$i</option>\n";}
			 else{$option .= "<option value='0$i'>0$i</option>\n";}
		  }
			if ($i >= 10){
			   if ($i == $jour){$option .= "<option value='$i' selected>$i</option>\n";}
	...
	function modif_liste_mois($mois){
	   ...
	   for ($i = 1; $i <= 12; $i++){
		  if ($i < 10){
			 if ($i == $mois){$option .= "<option value='0$i' selected>0$i</option>\n";}
			 else{$option .= "<option value='0$i'>0$i</option>\n";}
		  }else{
			 if ($i == $mois){$option .= "<option value='$i' selected>$i</option>\n";}
			 else{$option .= "<option value='$i'>$i</option>\n";}
		  }
	   }
	   return $option;
	...
	function modif_liste_annee($debut,$fin,$annee){
	   $option = "";
	   for ($i = date('Y') + $debut; $i <= date('Y') + $fin; $i++){
		  if ($i == $annee){$option .= "<option value='$i' selected='selected'>$i</option>\n";}
		  else{$option .= "<option value='$i'>$i</option>\n";}
	   }
	   return $option;
	}
	...
	function modif_liste_heure($heure){
	   ...
	   for ($i = 0; $i < 24; $i++){
			if ($i == $heure){
				if ($i < 10){$option .= "<option value='0$i' selected>0$i</option>\n";}
				if ($i >= 10){$option .= "<option value='$i' selected>$i</option>\n";}
			}else{
				if ($i < 10){$option .= "<option value='0$i'>0$i</option>\n";}
				if ($i >= 10){$option .= "<option value='$i'>$i</option>\n";}
			}
	...
	function commenceAvecVoyelle($mot){
		if(substr($mot,0,1)=='a' OR substr($mot,0,1)=='A'
		OR substr($mot,0,1)=='e' OR substr($mot,0,1)=='E'
		OR substr($mot,0,1)=='i' OR substr($mot,0,1)=='I'
		OR substr($mot,0,1)=='o' OR substr($mot,0,1)=='O'
		OR substr($mot,0,1)=='u' OR substr($mot,0,1)=='U'
		OR substr($mot,0,1)=='y' OR substr($mot,0,1)=='Y'){
			return true;
		}
		else{
			return false;
