<div class="resultatsCoupeCH">
	...
	*/ ?>
	<div class="informationsMatch" style="display:none;" id="infomatch1">
		...
		<div class="informationsBoxAutoQualif">Lausanne 1 est automatiquement qualifié</div>
	</div>
	<div class="informationsMatch" style="display:none;" id="infomatch2">
		<div class="informationsBoxJournee">Journée 1</div>
		<div class="informationsBoxTypeMatch">Huitième de finale</div>
		<div class="informationsBoxEquipes">Lausanne 2 - Chavannes</div>
		<div class="informationsBoxScore">Score final : 3 - 0</div>
		<div class="informationsBoxDate">17.01.2009 à 11h30</div>
		<div class="informationsBoxLieu">Vieux-Moulin, Lausanne</div>
	</div>
	<div class="informationsMatch" style="display:none;" id="infomatch3">
		<div class="informationsBoxJournee">Journée 1</div>
		<div class="informationsBoxTypeMatch">Huitième de finale</div>
		<div class="informationsBoxEquipes">Val-de-Ruz 2 est automatiquement qualifié</div>
	</div>
	<div class="informationsMatch" style="display:none;" id="infomatch4">
		<div class="informationsBoxJournee">Journée 1</div>
		<div class="informationsBoxTypeMatch">Huitième de finale</div>
		<div class="informationsBoxAutoQualif">Genève 2 est automatiquement qualifié</div>
	</div>
	...
	<div class="informationsMatch" style="display:none;" id="infomatch6">
		<div class="informationsBoxJournee">Journée 1</div>
		<div class="informationsBoxTypeMatch">Huitième de finale</div>
		<div class="informationsBoxEquipes">Genève 3 - Val-de-Ruz 1</div>
		<div class="informationsBoxScore">Score final : 0 - 3</div>
		<div class="informationsBoxDate">17.01.2009 à 9h30</div>
		<div class="informationsBoxLieu">Vieux-Moulin, Lausanne</div>
	</div>
	<div class="informationsMatch" style="display:none;" id="infomatch7">
		<div class="informationsBoxJournee">Journée 1</div>
		<div class="informationsBoxTypeMatch">Huitième de finale</div>
		<div class="informationsBoxEquipes">Genève 1 - Nyon</div>
	...
	<div class="informationsMatch" style="display:none;" id="infomatch8">
		<div class="informationsBoxJournee">Journée 1</div>
		<div class="informationsBoxTypeMatch">Huitième de finale</div>
		<div class="informationsBoxAutoQualif">La Chaux-de-Fonds est automatiquement qualifié</div>
	</div>
	<div class="informationsMatch" style="display:none;" id="infomatch9">
		<div class="informationsBoxJournee">Journée 1</div>
		<div class="informationsBoxTypeMatch">Quart de finale</div>
		<div class="informationsBoxEquipes">Lausanne 1 - Lausanne 2</div>
		<div class="informationsBoxScore">Score final : 3 - 1</div>
		<div class="informationsBoxDate">17.01.2009 à 15h30</div>
		<div class="informationsBoxLieu">Vieux-Moulin, Lausanne</div>
	</div>
	<div class="informationsMatch" style="display:none;" id="infomatch10">
		<div class="informationsBoxJournee">Journée 1</div>
		<div class="informationsBoxTypeMatch">Quart de finale</div>
		<div class="informationsBoxEquipes">Val-de-Ruz 2 - Genève 2</div>
	...
	<div class="informationsMatch" style="display:none;" id="infomatch11">
		...
		<div class="informationsBoxScore">Score final : 3 - 1</div>
		<div class="informationsBoxDate">17.01.2009 à 13h30</div>
		<div class="informationsBoxLieu">Vieux-Moulin, Lausanne</div>
	</div>
	<div class="informationsMatch" style="display:none;" id="infomatch12">
		<div class="informationsBoxJournee">Journée 1</div>
		<div class="informationsBoxTypeMatch">Quart de finale</div>
		<div class="informationsBoxEquipes">Genève 1 - Chaux-de-Fonds</div>
		<div class="informationsBoxScore">Score final : 3 - 1</div>
		<div class="informationsBoxDate">17.01.2009 à 13h30</div>
		<div class="informationsBoxLieu">Vieux-Moulin, Lausanne</div>
	</div>
	<div class="informationsMatch" style="display:none;" id="infomatch13">
		...
		<div class="informationsBoxEquipes">Lausanne 1 - Genève 2</div>
		<div class="informationsBoxScore">Score final : 3 - 0</div>
		<div class="informationsBoxDate">14.03.2009 à 09h00</div>
		<div class="informationsBoxLieu">Pommier, Grand Saconnex</div>
	</div>
	<div class="informationsMatch" style="display:none;" id="infomatch14">
		<div class="informationsBoxJournee">Journée 2</div>
		<div class="informationsBoxTypeMatch">Demi-finale</div>
		<div class="informationsBoxEquipes">Chambésy - Genève 1</div>
		<div class="informationsBoxScore">Score final : 3 - 1</div>
		<div class="informationsBoxDate">14.03.2009 à 10h30</div>
		<div class="informationsBoxLieu">Pommier, Grand Saconnex</div>
	</div>
	<div class="informationsMatch" style="display:none;" id="infomatch15">
		...
		<div class="informationsBoxScore">Score final : 3 - 1</div>
		<div class="informationsBoxDate">14.03.2009 à 16h00</div>
		<div class="informationsBoxLieu">Pommier, Grand Saconnex</div>
	</div>
	<div class="informationsMatch" style="display:none;" id="infomatch16">
		<div class="informationsBoxJournee">Journée 2</div>
		<div class="informationsBoxTypeMatch">Petite finale</div>
		<div class="informationsBoxEquipes">Genève 1 - Genève 2</div>
		<div class="informationsBoxScore">Score final : 3 - 0</div>
		<div class="informationsBoxDate">14.03.2009 à 14h00</div>
		<div class="informationsBoxLieu">Pommier, Grand Saconnex</div>
	</div>
	<div class="boxTour1">
		...
		<div class="boxEquipe1A" onMouseOver="afficherInfoMatch('2');" onMouseOut="masquerInfoMatch('2');">
			<span class="gagnant">Lausanne 2</span>
		</div>
	...
	<div class="boxTour2">
		...
		<div class="boxEquipe2B" onMouseOver="afficherInfoMatch('11');" onMouseOut="masquerInfoMatch('11');">
			<span class="perdant">Val-de-Ruz</span>
		</div>
